...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_opr
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  /data/users/oko001/cmaq_oper_data/cmaq_out/output_CCTM_${RUNID}  #> Output Directory
 setenv INPDIR  /data/users/oko001/cmaq_oper_data/            #> Input Directory
...
set STTIME     = 120000            #> beginning GMT time (HHMMSS)
...
setenv GRIDDESC  ${INPDIR}/static_and_default_files/GRIDDESC_2km    #> grid description file
...
#> Output Species and Layer Options
   ...
   setenv CONC_SPCS "O3 ACORS NO2 AOTHRI AOTHRJ" 
   setenv CONC_BLEV_ELEV " 1 2" #> CONC file layer range; comment to write all layers to CONC

   #> ACONC file species; comment or set to "ALL" to write all species to ACONC
   #setenv AVG_CONC_SPCS "O3 NO CO NO2 ASO4I ASO4J NH3" 
   setenv AVG_CONC_SPCS "BENZENE CO NH3 NO NO2 O3 SO2 ALVPO1I ASVPO1I ASVPO2I APOCI APNCOMI ALVPO1J ASVPO1J ASVPO2J APOCJ ASVPO3J AIVPO1J APNCOMJ ALVOO1I ALVOO2I ASVOO1I ASVOO2I AISO1J AISO2J AISO3J AMT1J AMT2J AMT3J AMT4J AMT5J AMT6J AMTNO3J AMTHYDJ AGLYJ ASQTJ AORGCJ AOLGBJ AOLGAJ ALVOO1J ALVOO2J ASVOO1J ASVOO2J ASVOO3J APCSOJ AAVB1J AAVB2J AAVB3J AAVB4J ASO4I ANO3I ANH4I ANAI ACLI AECI AOTHRI ASO4J ANO3J ANH4J ANAJ ACLJ AECJ AOTHRJ AFEJ ASIJ ATIJ ACAJ AMGJ AMNJ AALJ AKJ ASOIL ACORS ASEACAT ACLK ASO4K ANO3K ANH4K "
...
set EMISpath  = $INPDIR/emis_files/outputs-time_variate-oper_C0/                             #> gridded surface residential wood combustion emissions directory
set IN_PTpath = $INPDIR                             #> point source emissions input directory
set IN_LTpath = $INPDIR                             #> lightning NOx input directory
set METpath   = /data/users/oko001/cmaq_oper_data/mcip_files #> meteorology input directory 
...
set SZpath    = $INPDIR/static_and_default_files/   #> surf zone file for in-line seaspray emissions
...
while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
  ...
  set DAYm = `date -ud "${TODAYG}-1days" +%Y%m%d` #> 2 days before
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     set ICpath = $INPDIR/static_and_default_files
     setenv ICFILE ICON_v532_ala2km_33_2021_profile#ICFILE ICON_v532_wrf2021_v1_profile
     setenv INIT_MEDC_1 notused
  else
     set ICpath = /data/users/oko001/cmaq_oper_data/cmaq_out/output_CCTM_v533_intel_12_0_p_24/
     setenv ICFILE  CCTM_CGRID_v533_intel_12_0_p_24_${YESTERDAY}.nc
  ...
  #>
  setenv EMISSCTRL_NML /data/users/oko001/cmaq_oper_data/static_and_default_files/EmissCtrl_cb6r3_ae7_aq.nml
...
#  setenv N_EMIS_GR 4          #Number of gridded source groups
#  set EMISfile  = EM_2021_agri-${TODAYG}.nc
#  setenv GR_EMIS_001 ${EMISpath}/outputs-final-2021_agri/${EMISfile}
# setenv GR_EMIS_LAB_001 GRIDDED_EMIS_AGRI
#  setenv GR_EMIS_LAB_001 GR_AGRI   
#  setenv GR_EM_SYM_DATE_001 F

#  set EMISfile  = EM_2019_CDV_faza2-${TODAYG}.nc 
#  setenv GR_EMIS_002 ${EMISpath}/outputs-final-2021_CDV_faza2/${EMISfile}
#  setenv GR_EMIS_LAB_002 GRIDDED_EMIS_DOPR
#  setenv GR_EMIS_LAB_002 GR_DOPR
#  setenv GR_EM_SYM_DATE_002 F

#  set EMISfile  = EM_res_heat-${TODAYG}.nc
#  setenv GR_EMIS_003 ${EMISpath}/outputs-final-2021_res_heat/${EMISfile}
# setenv GR_EMIS_LAB_003 GRIDDED_EMIS_LOK_VYK
#  setenv GR_EMIS_LAB_003 GR_LOK_VYK
#  setenv GR_EM_SYM_DATE_003 F

#  set EMISfile  =  EM_2015_TNO-${TODAYG}.nc
#  setenv GR_EMIS_004 ${EMISpath}/outputs-final-2021_TNO/${EMISfile}
#  setenv GR_EMIS_LAB_004 GRIDDED_EMIS_TNO
#  setenv GR_EMIS_LAB_004 GR_TNO
#  setenv GR_EM_SYM_DATE_004 F

# Gridded Emissions Diagnostic files
#  setenv GR_EMIS_DIAG_001 2D
#  setenv GR_EMIS_DIAG_002 2D
#  setenv GR_EMIS_DIAG_003 2D
#  setenv GR_EMIS_DIAG_004 2D
...
#  set STKCASEE = 12US1_cmaq_cb6_2016ff_16j  # Stack Emission Version Label
  ...
  # Time-Independent Stack Parameters for Inline Point Sources
   setenv STK_GRPS_001 ${EMISpath}/STACK_PARAM.nc
#   setenv STK_GRPS_001 ${EMISpath}/STACK_PARAM.nc
#  setenv STK_GRPS_002 ${EMISpath}/outputs-final-2021_TNO/STACK_PARAM.nc
...
#  setenv STK_EMIS_008 $IN_PTpath/cmv_c3/inln_mole_cmv_c3_${YYYYMMDD}_${STKCASEE}.nc
  ...
  # Label Each Emissions Stream
   setenv STK_EMIS_LAB_001 ALL_STACKS
#  setenv STK_EMIS_LAB_001 ST_NEIS
#  setenv STK_EMIS_LAB_002 ST_TNO
...
#  setenv STK_EMIS_DIAG_002 2DSUM
 ...
 # setenv STK_EM_SYM_DATE_008 T
  ...
  setenv OCEAN_1 $SZpath/ocean #> horizontal grid-dependent surf zone file
...
#       setenv PA_BROW_EROW "10 80"  # default: all rows
        setenv PA_BLEV_ELEV "1  1"   # default: all levels
        setenv PACM_INFILE ${NMLpath}/pa_${MECH}_MOD.ctl
...
# ===================================================================
  ...
  mpirun -np $NPROCS  $BLD/$EXEC |& tee buff_${EXECUTION_ID}.tx
