...
/users/oko001/cmaq_oper_scripts/CMAQ_v5.3.3_oper/combine/run_combine_$2_$3_${end} $datum > /work/users/oko001/cmaq_oper_logs/postproc/combine_${datum}_$2_$3_${end}  2>&1

echo 'map creator'
/users/p6065/anaconda3/envs/supergeo/bin/python -u /users/oko001/cmaq_oper_scripts/postproc/map_creator.py  $datum $2 $3 > /work/users/oko001/cmaq_oper_logs/postproc/mapcrea_${datum}_$2_$3_${end}  2>&1
